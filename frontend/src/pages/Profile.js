            ...
            <nav className="navbar">
                ...
                <div className='profile-container'>
                    <div className='photocard'>
                        ...
                        <img className='pfp' src={profileImage || elon} alt="Alternate Image" style={{display: 'flex', height: '50%', justifyContent: 'center', alignItems: 'center', borderRadius: '50%', marginBottom: '10px'}}/>
                    ...
                    <div className='edit_space'>
                        <div className='orientation'>
                            <h1 style={{marginBottom: '40px'}}>Edit Profile</h1>
                            <div className='divide'>
                                <strong><u className= {`underline-bottom ${tab === 0 ? 'turn_black' : 'grey_underline'}`} style={{marginRight: '20px'}} onClick={handleSwitchTab1}>User Info</u></strong>
                                <strong><u className= {`underline-bottom ${tab === 1 ? 'turn_black' : 'grey_underline'}`} onClick={handleSwitchTab2}>Billing Info</u></strong>
                            </div>
                            {tab === 0 ? (
                                <div>
                                    <div className='divide'>
                                    ...
                                    <div className='photo_changing' style={{width: 85, marginTop: '10px'}}>Update Info</div>
                                </div>
                            ) : (
                                <div>
                                    <div className='divide'>
